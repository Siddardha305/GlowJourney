...
const Footer = () => {
  return (
    <footer className="bg-black border-t border-white/10 pt-20 pb-0 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 mb-20">
          ...
          <div className="lg:col-span-6 flex flex-col justify-between h-full space-y-8">
            <div className="space-y-4">
              <h3 className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#e31b6d] to-[#ff80b5]">
                Glow Journey
              </h3>
          ...
          <div className="lg:col-span-6 grid grid-cols-2 sm:grid-cols-3 gap-8">
            ...
            {/* Column 2 */}
            <div>
              <h4 className="text-sm font-semibold text-gray-300 uppercase tracking-wider mb-6">Resources</h4>
              <ul className="space-y-3 text-sm text-gray-400">
            ...
            <div>
              ...
              <div className="flex flex-col space-y-3">
                <Link href="https://www.youtube.com/@GlowJourney" target="_blank" className="flex items-center gap-2 text-sm text-gray-400 hover:text-theme-accent transition-colors">
                  <Youtube className="w-4 h-4" /> YouTube
                </Link>
                <Link href="https://www.instagram.com/glowjourney" target="_blank" className="flex items-center gap-2 text-sm text-gray-400 hover:text-theme-accent transition-colors">
                  <Instagram className="w-4 h-4" /> Instagram
                </Link>
                <Link href="https://github.com/glowjourney" target="_blank" className="flex items-center gap-2 text-sm text-gray-400 hover:text-theme-accent transition-colors">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 border-t border-white/5 pt-8 mb-12">
      ...
      <div className="w-full flex justify-center items-end pt-10">
        <h1 className="text-[12vw] sm:text-[14vw] leading-[0.8] font-bold text-transparent bg-clip-text bg-gradient-to-b from-[#e31b6d]/20 to-transparent select-none pointer-events-none transform translate-y-[10%]">
          Glow Journey
        </h1>
      </div>
    </footer >
