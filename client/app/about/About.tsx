  ...
  return (
    <div className="text-black dark:text-white pt-44">
      ...
      <h1 className={`${styles.title} 800px:!text-[45px]`}>
        What is <span className="text-gradient">Glow Journey?</span>
      </h1>
      ...
      <div className="w-[95%] 800px:w-[85%] m-auto">
        <p className="text-[18px] font-Poppins">
          ...
          no further than Glow Journey, the premier beauty community
        ...
        <br />
        <span className="text-[22px]">Glow Journey Team</span>
