...
userRouter.post("/enroll-user", auth_1.isAutheticated, (0, auth_1.authorizeRoles)("admin"), user_controller_1.enrollUserInCourse);
userRouter.post("/create-user", auth_1.isAutheticated, (0, auth_1.authorizeRoles)("admin"), user_controller_1.createUserByAdmin);
userRouter.post("/bulk-enroll-users", auth_1.isAutheticated, (0, auth_1.authorizeRoles)("admin"), upload.single("file"), user_controller_1.bulkEnrollUsers);
