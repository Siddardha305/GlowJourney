...
courseRouter.get("/course-enrollments/:courseId", auth_1.isAutheticated, (0, auth_1.authorizeRoles)("admin"), course_controller_1.getCourseEnrollments);
courseRouter.put("/remove-user-from-course", auth_1.isAutheticated, (0, auth_1.authorizeRoles)("admin"), course_controller_1.removeUserFromCourse);
