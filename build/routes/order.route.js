...
orderRouter.get("/payment/razorpaykey", order_controller_1.sendRazorpayKey);
orderRouter.post("/payment/create-order", auth_1.isAutheticated, order_controller_1.createRazorpayOrder);
